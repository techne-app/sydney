...
Available functions:
1. search_threads - Search and retrieve Hacker News discussion threads
   Parameters: 
...
- search_threads: "find", "search", "show me", "look up", "any posts about", "what's been said about"
...
- If no pinned thread and user asks about "this thread", still use search_threads with generic search
- Extract search keywords from natural language for search_threads
...
Examples:
- "find discussions about AI" → {"function": "search_threads", "parameters": {"keyword_filter": "AI"}, "confidence": 0.9, "reasoning": "Clear search request for AI discussions"}
- "show me recent React posts" → {"function": "search_threads", "parameters": {"keyword_filter": "React", "sort_by": "recent"}, "confidence": 0.9, "reasoning": "Search request with specific sorting"}
...
- "summarize this thread" (no pinned) → {"function": "search_threads", "parameters": {"keyword_filter": "thread discussion"}, "confidence": 0.7, "reasoning": "No pinned thread, fallback to search"}
- "find 5 startup discussions from this week" → {"function": "search_threads", "parameters": {"keyword_filter": "startup", "num_cards": 5, "hours_back": 168}, "confidence": 0.9, "reasoning": "Specific search with quantity and time constraints"}
